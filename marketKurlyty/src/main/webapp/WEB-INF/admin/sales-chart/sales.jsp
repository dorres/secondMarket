...
<body class="sb-nav-fixed">
					...
					<div class="card mb-4">
						...
						<div class="card-body">
							...
							<div style="text-align: center;">
								From: <input type="date" style="color: purple;"> To: <input
									type="date"><input type="button" value="조회"
									class="btn1">
							</div>
	...
	<script
		src="${pageContext.request.contextPath }/resources/js/chart-bar.js"></script>
	<script
