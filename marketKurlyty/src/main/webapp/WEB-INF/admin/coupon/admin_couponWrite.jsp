						...
						<form action="admin_membershipInsert.mdo" method="POST" >
								<table class="type02">
									<tr>
										...
										<td><input type="text" name="coupon_serial" placeholder="ex) 20% 특별 쿠폰"/></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td><input type="text" name="coupon_min_use" value="0"/></td>
									</tr>
									
									<tr>
									<th scope="row"  >쿠폰 금액/할인율</th>
										<td>
											<input type="text" name="coupon_discount_rate"/>
											<input type="radio" value="% 퍼센트" name="ordernoSelect" checked="checked">% 퍼센트 
											<input type="radio" value="원" name="ordernoSelect">원
										</td>
									</tr>
									<!-- 퍼센트 일경우 최대 할인금액 입력할수있게 readonly 상태를 변경? -->
									<tr>
										<th scope="row"  >쿠폰 최대 할인금액(%일경우)</th>
										<td><input type="text" name="coupon_discount_max"/></td>
									</tr>
...
$(document).ready(function(){
    $('#coupon_type').on('change', function() {
      var num =  $(this);
      if(num ==1){
    	  $("input[name='coupon_discount_max']").attr("readonly", false);
      }
    });
});
</script>	
