						...
						<table id="datatablesSimple">
							...
							<c:forEach var="stock" items="${stock}">
									<tr>
										...
										<td><input type="text" name="goods_stock_receiving_quantity" value="${stock.goods_stock_receiving_quantity}" readonly="readonly"/></td>
										<td><input type="text" name="goods_stock_stock_quantity" value="${stock.goods_stock_stock_quantity }" readonly="readonly"></td>
