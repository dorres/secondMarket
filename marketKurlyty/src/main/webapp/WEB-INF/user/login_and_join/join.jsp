						...
						<div class="type_form member_join ">
							<form id="form" name="frmMember" method="post" action="joinProc.do" novalidate="">
								<input type="hidden" name="mode" value="joinMember"> <input
									...
									value="https://www.kurly.com/shop/mypage/mypage_orderlist.php">
								<p class="page_sub">
									...
									<tbody>
										...
										<tr class="member_pwd">
											<th>비밀번호확인<span class="ico">*<span
													class="screen_out">필수항목</span></span></th>
											<td><input type="password" name="user_pw_check" maxlength="16" class="confirm_pw"
																...
																<table cellpadding="0" cellspacing="0" width="100%">
																	...
																	<tbody>
																		<tr>
																			...
																			<td rowspan="4" class="emph">회원 탈퇴 <br>즉시파기
																				<br> <br> 부정이용 방지를 위하여 30일 동안 보관 (아이디,휴대폰
																				번호) 후 파기
																			</td>
																		</tr>
																		<tr>
