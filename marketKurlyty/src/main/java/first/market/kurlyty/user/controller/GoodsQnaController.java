...
public class GoodsQnaController {
	...
	/*
	 * @GetMapping("/goodsQnaWrite.do") public String getUser(HttpServletRequest
	 * request, UserVO vo, Model model) { HttpSession session =
	 * request.getSession(); vo.setUser_id((String)session.getAttribute("userId"));
	 * 
